...
FoodItem::FoodItem(string name,double fat,double carbs,double protein){// Define second constructor with arguments
this->name=name;// to initialize private data members
this->fat = fat;
this->carbs = carbs;
